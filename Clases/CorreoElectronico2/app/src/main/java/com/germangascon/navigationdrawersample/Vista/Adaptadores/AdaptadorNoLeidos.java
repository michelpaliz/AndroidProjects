...
public class AdaptadorNoLeidos extends RecyclerView.Adapter<AdaptadorNoLeidos.HolderCorreoRecibidos> {

    private final Context context;
    private final IOnCorreoSeleccionado iOnCorreoSeleccionado;
    private final HashMap<Email, Contacto> hashMap;

    public AdaptadorNoLeidos(Context context, Cuenta cuenta, IOnCorreoSeleccionado iOnCorreoSeleccionado) {
        this.context = context;
        this.iOnCorreoSeleccionado = iOnCorreoSeleccionado;
        CorreoLogica correoLogica = new CorreoLogica(cuenta);
        hashMap = correoLogica.getCorreosNoLeidos();
    }
