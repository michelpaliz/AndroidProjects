...
public class FragmentoRecibidos extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        AdaptadorRecibidos adaptadorRecibidos = new AdaptadorRecibidos(getContext(),cuenta,iOnCorreoSeleccionado);
        RecyclerView recyclerView = view.findViewById(R.id.recyclerView);
        recyclerView.setHasFixedSize(true);
        recyclerView.setAdapter(adaptadorRecibidos);
