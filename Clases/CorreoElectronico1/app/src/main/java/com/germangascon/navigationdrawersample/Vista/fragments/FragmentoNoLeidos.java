...
import com.germangascon.navigationdrawersample.Vista.Adaptadores.AdaptadorNoLeidos;
import com.germangascon.navigationdrawersample.Vista.Adaptadores.AdaptadorSpam;

public class FragmentoNoLeidos extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        AdaptadorNoLeidos adaptadorNoLeidos = new AdaptadorNoLeidos(getContext(),cuenta,iOnCorreoSeleccionado);
        RecyclerView recyclerView = view.findViewById(R.id.recyclerView);
        recyclerView.setHasFixedSize(true);
        recyclerView.setAdapter(adaptadorNoLeidos);
