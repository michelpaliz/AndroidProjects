...
public class GridViewAdapter extends ArrayAdapter<Pais> {
    private final ArrayList<Pais> listaPaises;

    public GridViewAdapter(Context context, ArrayList<Pais> listaPaises) {
        super(context, R.layout.listgrid_item, listaPaises);
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ListViewAdapter.Holder holder = null;
        Pais pais = null;
...
//       LayoutInflater inflater = LayoutInflater.from(getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE));
        ...
        if (convertView == null) {
            ...
            holder = new ListViewAdapter.Holder();
            pais = new Pais();
             ...
             */
            holder = (ListViewAdapter.Holder) convertView.getTag();
        }
