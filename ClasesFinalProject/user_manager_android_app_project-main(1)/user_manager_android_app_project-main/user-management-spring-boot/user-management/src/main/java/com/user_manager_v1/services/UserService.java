...
public class UserService {
    ...
    public int registerNewUserServiceMethod(String fname, String lname, String email, String password, String type){
        return userRepository.registerNewUser(fname,lname,email,password,type);
    }
